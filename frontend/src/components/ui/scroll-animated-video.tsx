...
export const HeroScrollVideo: React.FC<HeroScrollVideoProps> = ({
    ...
    return (
        ...
        .hsv-root {
          /* Light */
          --bg: var(--bg);
          --text: #0ea5e9; /* Sky theme */
          --muted: #6b7280;
          --muted-bg: rgba(15,17,21,0.06);
          --muted-border: rgba(15,17,21,0.12);
          --overlay-bg: rgba(10,10,14,0.42);
          --overlay-text: #ffffff;
          --accent: #22c55e;    /* Green / Eco */
          --accent-2: #06b6d4;  /* Cyan / Water */
          --shadow: 0 10px 30px rgba(0,0,0,0.08);

          color-scheme: light dark;
          background: var(--bg, transparent); /* Inherit background */
          color: var(--text);
          font-family: inherit;
          overflow-x: clip;
        }
        ...
        .hsv-title {
          ...
          text-wrap: balance;
          background: linear-gradient(90deg, var(--text) 0%, var(--accent-2) 50%, var(--accent) 100%);
